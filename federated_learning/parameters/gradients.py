...
def calculate_model_gradient(logger, model_1, model_2):
    ...
    """
    model_1_parameters = list(dict(model_1.named_parameters()))
    model_2_parameters = list(dict(model_2.named_parameters()))
...
def calculate_parameter_gradients(logger, params_1, params_2):
    ...
    :param logger: loguru.logger
    :param model_1: dict(tensor)
    :param model_2: dict(tensor)
    """
    ...
    return numpy.array([x.detach().numpy() for x in numpy.subtract(params_1, params_2)])
